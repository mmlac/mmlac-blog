...
import headshot from '../../assets/photos/title-headshot.png'
...
<Image src={headshot} alt="Markus Lachinger" />
<br style="clear: left;" />
...
If you’re here for the Adeptus Mechanicus: sorry—this is about software engineering and leadership. Although, in the age of vibe coding and black-box AI models, we may be inching closer than we’d like to admit. 😅
